...
here will be written to vendor.js so they can be cached unitl one of them change.

So basically, this avoids customers having to download a huge JS file
anytime a line of code changes. They only have to downlaod vendor.js when
